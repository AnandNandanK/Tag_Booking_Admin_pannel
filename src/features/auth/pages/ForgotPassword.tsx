      ...
      <div className="h-screen flex items-center justify-center bg-gray-200 p-4">
        <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg p-6 sm:p-8 flex flex-col items-center">
          <img
            src="ticketlogo2.jpg"
            alt="MyTag Logo"
            className="w-30  object-contain mb-2 rounded"
          />
          ...
          <form className="w-full space-y-4" onSubmit={submitHandler}>
            ...
            <div className="flex justify-between gap-2">
              ...
              <div className="flex justify-center items-center w-1/2 text-center bg-sky-700 hover:bg-sky-600 text-white font-semibold rounded-full transition text-base cursor-pointer ">
                
                  
              <button
                type="submit"
                disabled={isDisabled}
                className={`w-1/2  text-white font-semibold  rounded-full transition text-base cursor-pointer  `}
              >
                Submit
              </button>
